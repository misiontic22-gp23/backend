...
import com.huellitas.backend.Services.ConsultaService;
...
public class ConsultaController {
    ...
    @PostMapping
    public ResponseEntity<?> insert(@RequestBody ConsultaData consulta) {
        return new ResponseEntity<>(consultaService.insert(consulta), HttpStatus.CREATED);
    }

    //Editar una consulta (por id)
    @PutMapping
    public ResponseEntity<?> update(@RequestBody ConsultaData consulta) {
